...
#define HOBD_TABLE_209_TRANSMISSION_STATE_GEAR (0)
#define HOBD_TABLE_209_TRANSMISSION_STATE_NEUTRAL (1)
#define HOBD_TABLE_209_TRANSMISSION_STATE_KICKSTAND (3)

#define HOBD_TABLE_209_ENGINE_STATE_OFF (0)
#define HOBD_TABLE_209_ENGINE_STATE_ON (1)
